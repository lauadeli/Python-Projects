'''
ESC204 2024S
PSA version 4 testing lights on together
Notes:
light red not as bright as green light or as bright as when lit by itself
resistor for red = 900
resistor for green = 300
'''
...
while True:
    ...
    #ledgreen.value = not button.value #light up if button is pressed# Write your code here :-)
